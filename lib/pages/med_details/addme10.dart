...
class Addme10 extends StatelessWidget {
  const Addme10({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final pillsPerBlister = prov.pillsPerBlister;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildCounterButton(
                        icon: Icons.remove,
                        onPressed: context.read<MedicineProvider>().decrementPillsPerBlister,
                      ),
                      ...
                      _buildCounterButton(
                        icon: Icons.add,
                        onPressed: context.read<MedicineProvider>().incrementPillsPerBlister,
                      ),
                    ],
                  ),
